                            ...
                            <div id="environment-settings" class="content get_form_data" role="tabpanel" aria-labelledby="environment-settings-trigger">
                                <form id="environment_form">
                                    ...
                                    <div class="content-header mb-2">
                                        ...
                                        <span>Enter Your Database & Application Info. | <a target="_blank" href="https://nulleb.com">NULLEB.COM</a></span>
                                    </div>
                            ...
                            <div id="profile-settings" class="content" role="tabpanel" aria-labelledby="profile-settings-trigger">
                                <form id="profile_form">
                                    ...
                                    <div class="content-header">
                                        <h5 class="fw-bolder mb-75">Update Your Profile Information | <a target="_blank" href="https://bit.ly/2QCCRlD">NULLED scriptzzz!</a></h5>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
